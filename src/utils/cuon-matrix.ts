/* TODO: 等待补全methods */
export interface Matrix4Interface {
  elements: Float32Array;
  setIdentity(): Matrix4Interface;
  set(src: Vector3Interface): Matrix4Interface;
  concat(other: Vector3Interface): Matrix4Interface;
  multiply(other: Vector3Interface): Matrix4Interface;
  concat(other: Vector4Interface): Matrix4Interface;
  multiply(other: Vector4Interface): Matrix4Interface;
  multiplyVector3(pos: Vector3Interface): Vector3Interface;
  multiplyVector4(pos: Vector4Interface): Vector4Interface;
}

export class Matrix4 implements Matrix4Interface {
  elements: Float32Array;

  constructor(opt_src?: Vector3Interface) {
    let i: number, s, d;
    if (
      opt_src &&
      ...
      s = opt_src.elements as Float32Array;
  ...
  set(src: Vector4Interface) {
    let i, s, d;
    s = src.elements as Float32Array;
    d = this.elements;
  ...
  concat(other: Vector4Interface) {
    let i, e, a, b, ai0, ai1, ai2, ai3;

    // Calculate e = a * b
    e = this.elements;
    a = this.elements;
    b = other.elements as Float32Array;
  ...
  multiplyVector3(pos: Vector3Interface) {
    var e = this.elements;
    var p = pos.elements as Float32Array;
    var v = new Vector3();
  ...
  multiplyVector4(pos: Vector4Interface) {
    var e = this.elements;
    var p = pos.elements;
    var v = new Vector4();
    var result = v.elements;
  ...
  setInverseOf(other: Vector4Interface) {
    var i, s, d, inv, det;
